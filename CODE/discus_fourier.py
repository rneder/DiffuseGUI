...
#       Get Fourier settings from DISCUS
        ...
        percent, lot_type, lot_num, lot_dim, lot_per = suite.discus_get_fourier()
        for i in range(4):
            for j in range(3):
...
#       Determine if an element was given for its characteristic radiation
        ...
        self.np_a = tk.Spinbox(self, from_=1, to=1001,width=8,justify='right',textvariable=self.np_aa,
                background='#FFFFFF', foreground='#0000FF')
        self.np_o = tk.Spinbox(self, from_=1, to=1001,width=8,justify='right',textvariable=self.np_oo,
                background='#FFFFFF', foreground='#0000FF')
        self.np_t = tk.Spinbox(self, from_=1, to=1001,width=8,justify='right',textvariable=self.np_tt,
                background='#FFFFFF', foreground='#0000FF')
        #
...
##      self.R0 = tk.Radiobutton(self,text='Element    ',variable=self.rad_type,value=2,
##                activeforeground='#F00',foreground='#00F', justify='left',
##                command=lambda: convert_setup(self, 3))
##      self.R1 = tk.Radiobutton(self,text='Wave length',variable=self.rad_type,value=0,
##                activeforeground='#F00',foreground='#00F', justify='left',
##                command=lambda: convert_setup(self, 1))
##      self.R2 = tk.Radiobutton(self,text='Energy',variable=self.rad_type,value=1,
##                activeforeground='#F00',foreground='#00F', justify='left',
##                command=lambda: convert_setup(self,-1))
##      #
##      self.yScroll = tk.Scrollbar(self, orient=tk.VERTICAL)
##      self.ele = tk.Listbox(self, height=1, width= 5,selectbackground='#FFFFFF',
##                 selectforeground='#0000FF',selectmode=tk.SINGLE,
##                 yscrollcommand=self.yScroll.set)
##      self.yScroll['command'] = self.ele.yview
##      self.ele.configure(exportselection=False)
##      for i in range(nwave):
##          self.ele.insert(i,self.symbols[i])
##      self.ele.selection_set(20)
##      self.ele.yview_scroll(20, tk.UNITS)
##      self.label_wvle_unit = tk.Label(self,text='Ang')
##      if self.rad_type.get() == 1:
##          self.label_ener_unit = tk.Label(self,text='meV')
##      else:
...
##      #
##      self.rad.bind('<ButtonRelease-1>', lambda eff: convert_event(eff, self, 1))
##      self.ele.bind('<ButtonRelease-1>', lambda eff: convert_element(eff, self, 0))
##      self.entry_wvle.bind('<FocusOut>', lambda eff: convert_focus(eff, self, 0))
##      self.entry_wvle.bind('<Leave>',    lambda eff: convert_focus(eff, self, 0))
##      self.entry_ener.bind('<FocusOut>', lambda eff: convert_focus(eff, self, 0))
##      self.entry_ener.bind('<Leave>',    lambda eff: convert_focus(eff, self, 0))
        #
##      self.adp = tk.IntVar()
##      self.adp.set(adp)
...
##      self.check_ano = ttk.Checkbutton(self,text='Use',variable=self.ano)
        ...
        self.EntryAver  = ttk.Entry(self,textvariable=self.Aver, width=8,justify='right')
        ...
        self.lot_shape = tk.Listbox(self, height=2, width=10,selectbackground='#FFFFFF',
                   selectforeground='#0000FF',selectmode=tk.SINGLE)
        ...
        self.lotn = tk.Spinbox(self, from_=1, to=1001,width=6, justify='right',textvariable=self.lotnn,
                background='#FFFFFF', foreground='#0000FF')
        #
        ...
        self.lotx = tk.Spinbox(self, from_=1, to=1001,width=6,justify='right',textvariable=self.lotxx,
                background='#FFFFFF', foreground='#0000FF')
        self.loty = tk.Spinbox(self, from_=1, to=1001,width=6,justify='right',textvariable=self.lotyy,
                background='#FFFFFF', foreground='#0000FF')
        self.lotz = tk.Spinbox(self, from_=1, to=1001,width=6,justify='right',textvariable=self.lotzz,
                background='#FFFFFF', foreground='#0000FF')
        #
        ...
        #
        #
        self.show= ttk.Button(self, text='Show', command=lambda: self.show_fourier(parent, \
        corners, increment, radiation, wvle, ener, adp, ano, percent, lot_type, \
        lot_num, lot_dim, lot_per ))
        #
        #
        create_exit_button(self,'discus',11,8,self.exit_command,(parent, \
        corners, increment, radiation, wvle, ener, adp, ano, percent, lot_type, \
        lot_num, lot_dim, lot_per ))
        #
        #
...
##      self.label_rad.grid(row=1,column=4,padx=(5,0),sticky='EW')
##      self.rad.grid(row=1,column=5,rowspan=3,sticky='EW')
##      self.R0.grid(row=1,column=6,sticky='EWNS')
##      self.R1.grid(row=2,column=6,sticky='EW')
##      self.R2.grid(row=3,column=6,sticky='EW')
##      self.ele.grid(row=1,column=7,sticky='EWNS')
##      self.yScroll.grid(row=1,column=8,sticky='W')
...
##      self.check_ano.grid(row=5,column=5,sticky='EW')
    ...
    def lot_menu(self, choice):
        if choice            ==1:
            self.label_lotshape.configure(foreground='#000000')
            self.label_lotnum.configure(foreground='#000000')
            self.label_lotdimx.configure(foreground='#000000')
            self.label_lotdimy.configure(foreground='#000000')
            self.label_lotdimz.configure(foreground='#000000')
            self.label_lot_per.configure(foreground='#000000')
            ...
            self.label_lotshape.configure(foreground='#A0A0A0')
            self.label_lotnum.configure(foreground='#A0A0A0')
            self.label_lotdimx.configure(foreground='#A0A0A0')
            self.label_lotdimy.configure(foreground='#A0A0A0')
            self.label_lotdimz.configure(foreground='#A0A0A0')
            self.label_lot_per.configure(foreground='#A0A0A0')
...
#
        ...
        if self.lot_use.get() == 0:
           ...
           if self.lot_per.get()== 1:
              ...
              period = 'no'
           if shape==0:
              line = 'lots ' + 'box,' + str(self.lotx.get()) + ',' + str(self.loty.get()) + ',' + \
                                        str(self.lotz.get()) + ',' + str(self.lotn.get()) + ',' + period
           else:
              line = 'lots ' + 'box,' + str(self.lotx.get()) + ',' + str(self.loty.get()) + ',' + \
                                      str(self.lotz.get()) + ',' + str(self.lotn.get()) + ',' + period
        suite.discus_calc_fourier(line)
