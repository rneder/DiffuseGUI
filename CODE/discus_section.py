...
#
      ...
      self.b_exit.grid(row=1, column=5,sticky=W)


   def command(self):
      self.cmds = command_gui(self,'discus')
   ...
   def discus_session(self):
      turn_off(self.b_strumenu, self.b_command, self.b_macro, self.b_help)
      control_label(self, "interactive", "discus", 2)
      turn_on(self.b_strumenu, self.b_command, self.b_macro, self.b_help)

   def discus_help(self):
      turn_off(self.b_session,self.b_strumenu, self.b_command, self.b_macro)
      control_label(self, "help", "discus", 2)
      turn_on(self.b_session,self.b_strumenu, self.b_command, self.b_macro)
